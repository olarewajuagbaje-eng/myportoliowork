...
BEGIN
  IF NEW.email IS NOT NULL
     AND lower(NEW.email) = 'olarewajuagbaje@gmail.com'
...
-- Backfill: if the account already exists and is confirmed, grant admin now.
INSERT INTO public.user_roles (user_id, role)
SELECT id, 'admin'::app_role FROM auth.users
WHERE lower(email) = 'olarewajuagbaje@gmail.com' AND email_confirmed_at IS NOT NULL
ON CONFLICT (user_id, role) DO NOTHING;
